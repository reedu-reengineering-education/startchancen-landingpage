...
export default function Datenschutz() {
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        <div className="legal-content">
          ...
          <p>
            ...
            ist Reedu GmbH &amp; Co. KG, Von-Steuben-Str. 21, 48143
            M&uuml;nster, Deutschland, Tel.: +49 (0) 251 98119797, E-Mail:
            kontakt&#64;reedu.de. Der f&uuml;r die Verarbeitung von
            personenbezogenen Daten Verantwortliche ist diejenige
            nat&uuml;rliche oder juristische Person, die allein oder gemeinsam
          ...
          <p>
            ...
            und zum Schutz der &Uuml;bertragung personenbezogene Daten und
          ...
          <p>
            ...
            Besuch auf der Website). Sofern durch einzelne von uns
            implementierte Cookies auch personenbezogene Daten verarbeitet
            werden, erfolgt die Verarbeitung gem&auml;&szlig; Art. 6 Abs. 1 lit.
            b DSGVO entweder zur Durchf&uuml;hrung des Vertrages oder
            gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO zur Wahrung unserer
            berechtigten Interessen an der bestm&ouml;glichen
          ...
          <p>
            ...
            der Daten ist unser berechtigtes Interesse an der Beantwortung Ihres
            Anliegens gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO. Zielt Ihre
          ...
          <h2>
            5) Datenverarbeitung bei Er&ouml;ffnung eines Kundenkontos und zur
            Vertragsabwicklung
          </h2>
          ...
          <p>
            <b>6.1</b>&thinsp;Anmeldung zu unserem E-Mail-Newsletter
          </p>
          ...
          <p>
            ...
            allein Ihre E-Mailadresse. Die Angabe weiterer evtl. Daten ist
            freiwillig und wird verwendet, um Sie pers&ouml;nlich ansprechen zu
            ...
            ausdr&uuml;cklich best&auml;tigt haben, dass Sie in den Versand von
          ...
          <p>
            <b>6.2</b>&thinsp;Newsletter-Versand via MailChimp
          </p>

          <p>
            Der Versand unserer E-Mail-Newsletter erfolgt &uuml;ber den
            technischen Dienstleister The Rocket Science Group, LLC d/b/a
            MailChimp, 675 Ponce de Leon Ave NE, Suite 5000, Atlanta, GA 30308,
            USA (http://www.mailchimp.com/), an die wir Ihre bei der
            Newsletteranmeldung bereitgestellten Daten weitergeben. Diese
            Weitergabe erfolgt gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO und
            dient unserem berechtigten Interesse an der Verwendung eines
            werbewirksamen, sicheren und nutzerfreundlichen Newslettersystems.
            Bitte beachten Sie, dass Ihre Daten in der Regel an einen Server von
            MailChimp in den USA &uuml;bertragen und dort gespeichert werden.
          </p>
          ...
          <p>
            ...
            der Empf&auml;nger anzupassen.
          </p>

          <p>
            Wenn Sie der Datenanalyse zu statistischen Auswertungszwecken
            widersprechen m&ouml;chten, m&uuml;ssen Sie den Newsletterbezug
            abbestellen.
          </p>

          <p>
            Des Weiteren kann MailChimp diese Daten gem&auml;&szlig; Art. 6 Abs.
            1 lit. f DSGVO selbst aufgrund seines eigenen berechtigten
            ...
            MailChimp nutzt die Daten unserer Newsletterempf&auml;nger jedoch
          ...
          <p>
            ...
            Datenverarbeitungsauftrag (&bdquo;Data-Processing-Agreement&ldquo;)
            auf Basis der Standardvertragsklauseln der Europ&auml;ischen
            Kommission abgeschlossen, um die &Uuml;bermittlung Ihrer
            personenbezogenen Daten an MailChimp zu erm&ouml;glichen. Dieser
          ...
          <p>
            MailChimp ist dar&uuml;ber hinaus unter dem us-europ&auml;ischen
            Datenschutzabkommen &bdquo;Privacy Shield&ldquo; zertifiziert und
            verpflichtet sich damit, die EU-Datenschutzvorgaben einzuhalten.
          </p>

          <p>
            Die Datenschutzbestimmungen von MailChimp k&ouml;nnen Sie hier
          ...
          <p>
            <b>7.1</b>&thinsp;Zur Abwicklung Ihrer Bestellung arbeiten wir mit
          ...
          <p>
            ...
            Zahlungsdienstleister eingesetzt werden, informieren wir
            hier&uuml;ber nachstehend explizit. Die Rechtsgrundlage f&uuml;r die
            Weitergabe der Daten ist hierbei Art. 6 Abs. 1 lit. b DSGVO.
          </p>

          <p>
            <b>7.2</b>&thinsp;Verwendung von Paymentdienstleistern
          ...
          <p>
            ...
            PayPal oder &ndash; falls angeboten - &quot;Kauf auf Rechnung&quot;
            oder &bdquo;Ratenzahlung&ldquo; via PayPal geben wir Ihre
            Zahlungsdaten im Rahmen der Zahlungsabwicklung an die PayPal
            (Europe) S.a.r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449
            Luxembourg (nachfolgend &quot;PayPal&quot;), weiter. Die Weitergabe
            erfolgt gem&auml;&szlig; Art. 6 Abs. 1 lit. b DSGVO und nur
            insoweit, als dies f&uuml;r die Zahlungsabwicklung erforderlich ist.
            <br />
            PayPal beh&auml;lt sich f&uuml;r die Zahlungsmethoden Kreditkarte
            via PayPal, Lastschrift via PayPal oder &ndash; falls angeboten -
            &quot;Kauf auf Rechnung&quot; oder &bdquo;Ratenzahlung&ldquo; via
            PayPal die Durchf&uuml;hrung einer Bonit&auml;tsauskunft vor.
            Hierf&uuml;r werden Ihre Zahlungsdaten gegebenenfalls
            gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO auf Basis des
            berechtigten Interesses von PayPal an der Feststellung Ihrer
            Zahlungsf&auml;higkeit an Auskunfteien weitergegeben. Das Ergebnis
            der Bonit&auml;tspr&uuml;fung in Bezug auf die statistische
            ...
            einflie&szlig;en, haben diese ihre Grundlage in einem
            ...
            nicht ausschlie&szlig;lich, Anschriftendaten ein. Weitere
            datenschutzrechtliche Informationen, unter anderem zu den
            verwendeten Auskunfteien, entnehmen Sie bitte der
            ...
            sofern dies zur vertragsgem&auml;&szlig;en Zahlungsabwicklung
            erforderlich ist.
          </p>
          ...
          <p>
            ...
            USA (&bdquo;Google&ldquo;) geh&ouml;rt.
          </p>
          ...
          <p>
            ...
            wertet diese aus. Eine solche Auswertung erfolgt insbesondere
            gem&auml;&szlig; Art. 6 Abs. 1 lit.f DSGVO auf Basis der
            berechtigten Interessen von Google an der Einblendung
            personalisierter Werbung, Marktforschung und/oder bedarfsgerechten
            Gestaltung seiner Website. Ihnen steht ein Widerspruchsrecht zu
            gegen die Bildung dieser Nutzerprofile, wobei Sie sich zur
            Aus&uuml;bung dessen an YouTube richten m&uuml;ssen.
          </p>
          ...
          <p>
            ...
            &bdquo;DoubleClick&ldquo; aufgenommen, was ohne unseren Einfluss
            weitere Datenverarbeitungsvorg&auml;nge ausl&ouml;sen kann.
          </p>

          <p>
            Google LLC mit Sitz in den USA ist f&uuml;r das us-europ&auml;ische
            Datenschutz&uuml;bereinkommen &bdquo;Privacy Shield&ldquo;
            zertifiziert, welches die Einhaltung des in der EU geltenden
            Datenschutzniveaus gew&auml;hrleistet.
          </p>

          <p>
            Weitere Informationen zum Datenschutz bei &bdquo;YouTube&ldquo;
            finden Sie in der Datenschutzerkl&auml;rung des Anbieters unter:
          ...
          <p>
            ...
            Webanalysedienst-Software Matomo (www.matomo.org), einem Dienst des
            Anbieters InnoCraft Ltd., 150 Willis St, 6011 Wellington,
            Neuseeland, (&bdquo;Mataomo&ldquo;) auf Basis unseres berechtigten
            Interesses an der statistischen Analyse des Nutzerverhaltens zu
            Optimierungs- und Marketingzwecken gem&auml;&szlig; Art. 6 Abs. 1
            lit. f DSGVO Daten gesammelt und gespeichert. Aus diesen Daten
            k&ouml;nnen zum selben Zweck pseudonymisierte Nutzungsprofile
            erstellt und ausgewertet werden. Hierzu k&ouml;nnen Cookies
            ...
            Seitenbesuchers gespeichert werden. Die Cookies erm&ouml;glichen
            unter anderem die Wiedererkennung des Internet-Browsers. Die mit der
            Matomo-Technologie erhobenen Daten (einschlie&szlig;lich Ihrer
          ...
          <p>
            ...
            Sitzungsdaten erhebt. Bitte beachten Sie, dass die vollst&auml;ndige
            L&ouml;schung Ihrer Cookies zur Folge hat, dass auch das
            Opt-Out-Cookie gel&ouml;scht wird und ggf. von Ihnen erneut
          ...
          <p>
            <b>10.1</b>&thinsp;Das geltende Datenschutzrecht gew&auml;hrt Ihnen
          ...
          <p>
            <b>10.2</b>&thinsp;WIDERSPRUCHSRECHT
          </p>
          ...
          <p>
            ...
            werden die entsprechenden Daten routinem&auml;&szlig;ig
